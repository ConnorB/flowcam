...
them into an animated GIF using the `magick` package. Provide either
...
- fps:
  ...
  Positive number. Approximate frames per second. Will be snapped to the
  nearest factor of 100 (1, 2, 4, 5, 10, 20, 25, 50, 100) as required by
  `magick`. Default is `2`.
